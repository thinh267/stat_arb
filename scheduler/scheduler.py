...
def signal_task():
    ...
    print(f"[Signal] Đang tạo signals cho timeframe 30m...")
    signals = generate_and_save_signals()
    if signals:
        print(f"[Signal] ✅ Hoàn thành tạo và lưu signals cho timeframe 30m")
    else:
        print(f"[Signal] ⚠️ Không có signals nào cho timeframe 30m")
